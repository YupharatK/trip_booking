...
import 'package:trip_booking/models/response/trip_get_res.dart';
import 'package:trip_booking/pages/profile.dart';
import 'package:trip_booking/pages/trip.dart';
import 'package:http/http.dart' as http;

class ShowtripPage extends StatefulWidget {
  final int idx;
  const ShowtripPage({super.key, required this.idx});
            ...
            children: [
              const Padding(
                padding: EdgeInsets.all(
                  16.0,
                ), // ปรับค่าเพื่อเพิ่มช่องว่างรอบๆ ข้อความ
                child: Text(
                  'ปลายทาง',
